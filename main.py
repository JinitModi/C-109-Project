...
for i in range(0, 1000):
    dice1 = random.randint(2, 5)
    dice2 = random.randint(2, 5)
...
fig = ff.create_distplot([dice_result], ["Writing Score"], show_hist=False)
fig.add_trace(go.Scatter(x=[first_std_deviation_start, first_std_deviation_start], y=[0, 0.7], mode="lines", name="Reading Score"))
fig.add_trace(go.Scatter(x=[first_std_deviation_end, first_std_deviation_end], y=[0, 0.7], mode="lines", name="Math Score"))
fig.add_trace(go.Scatter(x=[0, 0.7], y=[second_std_deviation_start, second_std_deviation_start], mode="lines", name="Lunch"))
fig.add_trace(go.Scatter(x=[0, 0.7], y=[second_std_deviation_end, second_std_deviation_end], mode="lines", name="Gender"))
fig.show()
